 ...
 * i RestClientConfig gjør, via EntraIDRestClientFactory). Uten
 * jsonMapper fra no.nav.familie.kontrakter.felles bruker Spring sin default JsonMapper, som mangler
...
class RestClientConfigJsonMapperTest {
    ...
    @Test
    fun `oppdragRestClient serialiserer felter som starter med æøå riktig`() {
        ...
        val restClient = restClientConfig.oppdragRestClient("dummy-scope")
        restClient
            .post()
