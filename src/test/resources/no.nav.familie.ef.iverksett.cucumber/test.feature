...
Egenskap: Andelhistorikk: Vedtak opphører midt i periode
  ...
  Scenario: Periode fjernes som følge av opphør i sin helhet
    ...
    Gitt følgende vedtak for behandling 1
  ...

    Gitt følgende vedtak for behandling 2
  ...
