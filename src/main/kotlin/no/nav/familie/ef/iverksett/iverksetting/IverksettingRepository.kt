...
class IverksettingRepository(val namedParameterJdbcTemplate: NamedParameterJdbcTemplate) {
    ...
    private fun lagreIverksett(behandlingId: UUID, iverksett: Iverksett) {
        val sql = "INSERT INTO iverksett VALUES(:behandlingId, :iverksettJson::JSON, :eksternId)"
    ...
    companion object {
        ...
        const val HENT_IVERKSETT_SQL = "SELECT data FROM iverksett WHERE behandling_id = :behandlingId"
