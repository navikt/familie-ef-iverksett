...
data class TilkjentYtelse(
    ...
    val startmåned: YearMonth = startdato?.let { YearMonth.from(startdato) } ?: andelerTilkjentYtelse.minOfOrNull { it.periode.fom } ?: error("Startdato eller startmåned må ha verdi")
) {
