...
data class TilkjentYtelse(
    ...
    val startmåned: YearMonth? = startdato?.let { YearMonth.from(startdato) } ?: andelerTilkjentYtelse.minOfOrNull { it.periode.fom } ?: error("Startdato eller startmåned eller andeler må ha verdi")
) {
